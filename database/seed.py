...
def seed_data():
    ...
    session.add_all([
        Employee(id="E234", name="Kiran", policy_limit=850.0, risk_tier="low", manager_slack_id="U125"),
        Employee(id="E100", name="Priya", policy_limit=5000.0, risk_tier="medium", manager_slack_id="U001"),
